...
const Perfumes = () => {
  ...
  useEffect(() => {
    axios.get('https://ab7dae03-a654-4f5e-b84e-6b7924e2581c-00-etotsp6h5au4.sisko.replit.dev/api/products/category/perfume')
      .then(res => {
  ...
  return (
    <div>
      <HeroSection
        ...
        subtitle="Discover the essence of luxury with our premium perfume collection"
        image="/images/perfume-main.avif"
      />

      <div className="p-6 max-w-7xl mx-auto dark:bg-gray-900">
        {/* Filter Bar */}
        <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
          <h2 className="text-2xl font-bold dark:text-white">Available Perfumes</h2>
